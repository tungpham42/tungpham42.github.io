...
const formatValue = (value, type) => {
    ...
    switch (type) {
        case 'VND':
            var dong = new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(value);
            return dong;
            break;
        case '%':
            return formatted + '%';
...
const calculate = () => {
	...
	displayResults(formatValue(amount, 'VND'), duration, formatValue(totalContribution, 'VND'), formatValue(totalReturn, 'VND'), formatValue(finalBalance, 'VND'));
}
